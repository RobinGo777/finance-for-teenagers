...
async def generate_ai_news(focus: str | None = None) -> dict:
    ...
    if focus:
        task = (
            ...
            "Покажи наслідок через конкретну ситуацію чи деталь, а не через "
            "окремий блок «чому це важливо». Можеш уточнити деталі через пошук."
        )
    else:
        task = (
            ...
            "IT-компанії. Напиши захопливий пост: одна думка, розкрита через "
            "конкретику — цифру, деталь або живий приклад. Можеш взяти одну з "
