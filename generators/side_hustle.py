...
async def generate_side_hustle() -> dict:
    ...
    task = (
        "Розбери один легальний підробіток для підлітка в Україні. Не обіцяй "
        "гарантований дохід. Покажи потрібну навичку, перший безпечний спосіб знайти "
        "клієнта, стартову ціну як орієнтовний діапазон та типову помилку. "
